...
const SupplierEdit = () => {
  ...
  const [form, submit, updateValue] = useForm("put", route("suppliers.update", item.id), {
    ...
    alternate_contact_details: item.alternate_contact_details ?? "",
    phone: item.phone ?? "",
    ...
    msme_registration_number: item.msme_registration_number ?? "",
    cin_number: item.cin_number ?? "",
    trade_license_number: item.trade_license_number ?? "",
    compliance_certificates: item.compliance_certificates ?? "",
    ...
    upi_id: item.upi_id ?? "",
    material_categories_supplied: item.material_categories_supplied ?? "",
    preferred_supplier: Boolean(item.preferred_supplier),
